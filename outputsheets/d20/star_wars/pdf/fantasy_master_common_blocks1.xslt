...
<!-- Blocks to put together PC Sheet -->
	...
	<xsl:import href="common_sheet/block_hp_defense5e.xslt"/>
	<xsl:import href="common_sheet/block_misc.xslt"/>
	<xsl:import href="common_sheet/block_pc_header_row5e.xslt"/>
	...
	<xsl:import href="common_sheet/block_weapons5e.xslt"/>
<!-- END -->
			...
			<fo:table-body>
				<fo:table-row keep-with-next="always" keep-together="always">
					...
					<fo:table-cell text-align="center" wrap-option="no-wrap" border-top-color="black" border-top-style="solid" border-top-width="0.1pt" background-color="transparent" padding-top="2pt">
						<fo:block text-align="center" font-size="5pt">PCGen Character Template by Frugal, based on work by ROG, Arcady, Barak, Dimrill, Dekker, Andrew Maitland (LegacyKing) &amp; JD.</fo:block>
